...
<article className='grid grid-rows-2 md:grid-cols-2 md:gap-x-10 text-justify mt-12 md:mt-0'>

<section class='my-12 md:my-24 font-mono prose prose-lg lg:prose-xl prose-invert'>
